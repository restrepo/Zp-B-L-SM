...
Module InputOutput_ZpBminusLSM 
...
Do 
 ...
 End If 
   ...
   Else If (read_line(7:10).Eq."YXIN") Then 
InputValueforYx= .True. 
    Call ReadMatrixC(99,3,3,YxIN,0, "YxIN",kont)

 
   Else If (read_line(7:12).Eq."IMYXIN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IMYx") 
       Cycle 
     End If 
    Call ReadMatrixC(99,3,3,YxIN,1, "YxIN",kont)
...
InputValueforYu= .True. 
   ...
   Else If (read_line(7:10).Eq."BLIN") Then 
    Call Read_BLIN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:12).Eq."IMBLIN") Then 
    Call Read_BLIN(99,1,i_model,set_mod_par,kont) 
   ...
   Else If (read_line(7:14).Eq."ANGLESIN") Then 
    Call Read_ANGLESIN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:16).Eq."IMANGLESIN") Then 
    Call Read_ANGLESIN(99,1,i_model,set_mod_par,kont) 
...
If (i_c.Eq.0) g1pINPUT= Cmplx(wert,Aimag(g1pINPUT),dp) 
If (i_c.Eq.1) g1pINPUT= Cmplx(Real(g1pINPUT,dp),wert,dp) 
Else If (i_par.Eq.11) Then 
If (i_c.Eq.0) g1p1INPUT= Cmplx(wert,Aimag(g1p1INPUT),dp) 
If (i_c.Eq.1) g1p1INPUT= Cmplx(Real(g1p1INPUT,dp),wert,dp) 
Else If (i_par.Eq.12) Then 
If (i_c.Eq.0) g11pINPUT= Cmplx(wert,Aimag(g11pINPUT),dp) 
If (i_c.Eq.1) g11pINPUT= Cmplx(Real(g11pINPUT,dp),wert,dp) 
Else If (i_par.Eq.20) Then 
If (i_c.Eq.0) vXinput= Cmplx(wert,Aimag(vXinput),dp) 
If (i_c.Eq.1) vXinput= Cmplx(Real(vXinput,dp),wert,dp) 
Else
...
Complex(dp) :: PDGhh(2),PDGAh(2),PDGHm,PDGVP,PDGVZ,PDGVG,PDGVWm,PDGgP,PDGgWm,PDGgWmC,PDGgZ,          & 
& PDGgG,PDGVZp,PDGgZp,PDGFd(3),PDGFu(3),PDGFe(3),PDGFv(6)

Character(len=30),Dimension(2):: NameParticlehh
Character(len=30),Dimension(2):: NameParticleAh
Character(len=30) :: NameParticleHm
...
Write(io_L,100) "# SUSY Les Houches Accord 2 - Zp/BminusLSM Spectrum + Decays + Flavor Observables"
...
Write(io_L,101) 10, Real(g1pINPUT,dp) ,"# g1pINPUT"
Write(io_L,101) 11, Real(g1p1INPUT,dp) ,"# g1p1INPUT"
Write(io_L,101) 12, Real(g11pINPUT,dp) ,"# g11pINPUT"
Write(io_L,101) 20, Real(vXinput,dp) ,"# vXinput"
...
If (Abs(Aimag(g1pINPUT)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(g1p1INPUT)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(g11pINPUT)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(vXinput)).gt.0._dp) WriteNextBlock = .True. 
...
End if 
If (Abs(Aimag(g1pINPUT)).gt.0._dp) Then 
Write(io_L,101) 10, Aimag(g1pINPUT) ,"# g1pINPUT"
End if 
If (Abs(Aimag(g1p1INPUT)).gt.0._dp) Then 
Write(io_L,101) 11, Aimag(g1p1INPUT) ,"# g1p1INPUT"
End if 
If (Abs(Aimag(g11pINPUT)).gt.0._dp) Then 
Write(io_L,101) 12, Aimag(g11pINPUT) ,"# g11pINPUT"
End if 
If (Abs(Aimag(vXinput)).gt.0._dp) Then 
Write(io_L,101) 20, Aimag(vXinput) ,"# vXinput"
End if 
End if 
...
Write(io_L,104) 4,gBLGUT, "# g1p(Q)^DRbar" 
...
Write(io_L,104) 10,Real(MUP,dp), "# MUP" 
If (Abs(Aimag(MUP)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 11,Real(mu,dp), "# mu" 
If (Abs(Aimag(mu)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 43,Real(vX,dp), "# vX" 
Write(io_L,104) 43,Real(vX,dp), "# vX" 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMBL Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 2,Aimag(lam2), "# lam2" 
Write(io_L,104) 3,Aimag(lam3), "# lam3" 
Write(io_L,104) 1,Aimag(lam1), "# lam1" 
Write(io_L,104) 10,Aimag(MUP), "# MUP" 
Write(io_L,104) 11,Aimag(mu), "# mu" 
End if 
WriteNextBlock = .false. 
...
End if 
WriteNextBlock = .false. 
Write(io_L,106) "Block ANGLES Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 10,Real(ACos(Abs(ZZ(3,3))),dp), "# TWp" 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMANGLES Q=",Q,"# (Renormalization Scale)" 
End if 
If (WriteTreeLevelTadpoleParameters) Then 
If (HighScaleModel.Eq."LOW") Then 
WriteNextBlock = .false. 
Write(io_L,106) "Block TREEBL Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 10,Real(MUPTree,dp), "# MUP" 
If (Abs(Aimag(MUPTree)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 11,Real(muTree,dp), "# mu" 
If (Abs(Aimag(muTree)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block TREEIMBL Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 10,Aimag(MUPTree), "# MUP" 
Write(io_L,104) 11,Aimag(muTree), "# mu" 
End if 
WriteNextBlock = .false. 
Write(io_L,106) "Block LOOPBL Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 10,Real(MUP1L,dp), "# MUP" 
If (Abs(Aimag(MUP1L)).gt.0._dp) WriteNextBlock = .True. 
Write(io_L,104) 11,Real(mu1L,dp), "# mu" 
If (Abs(Aimag(mu1L)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block LOOPIMBL Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 10,Aimag(MUP1L), "# MUP" 
Write(io_L,104) 11,Aimag(mu1L), "# mu" 
End if 
Else 
WriteNextBlock = .false. 
Write(io_L,106) "Block TREEBL Q=",Q,"# (Renormalization Scale)" 
...
End if 
End if 
Write(io_L,106) "Block YX Q=",Q,"# (Renormalization Scale)" 
Write(io_L,107)1,1,Real(Yx(1,1),dp), "# Real(Yx(1,1),dp)" 
Write(io_L,107)1,2,Real(Yx(1,2),dp), "# Real(Yx(1,2),dp)" 
Write(io_L,107)1,3,Real(Yx(1,3),dp), "# Real(Yx(1,3),dp)" 
Write(io_L,107)2,1,Real(Yx(2,1),dp), "# Real(Yx(2,1),dp)" 
Write(io_L,107)2,2,Real(Yx(2,2),dp), "# Real(Yx(2,2),dp)" 
Write(io_L,107)2,3,Real(Yx(2,3),dp), "# Real(Yx(2,3),dp)" 
Write(io_L,107)3,1,Real(Yx(3,1),dp), "# Real(Yx(3,1),dp)" 
Write(io_L,107)3,2,Real(Yx(3,2),dp), "# Real(Yx(3,2),dp)" 
Write(io_L,107)3,3,Real(Yx(3,3),dp), "# Real(Yx(3,3),dp)" 
If (MaxVal(Abs(AImag(Yx))).gt.0._dp) Then 
Write(io_L,106) "Block IMYX Q=",Q,"# (Renormalization Scale)" 
Write(io_L,107)1,1,Aimag(Yx(1,1)), "# Aimag(Yx(1,1))" 
Write(io_L,107)1,2,Aimag(Yx(1,2)), "# Aimag(Yx(1,2))" 
Write(io_L,107)1,3,Aimag(Yx(1,3)), "# Aimag(Yx(1,3))" 
Write(io_L,107)2,1,Aimag(Yx(2,1)), "# Aimag(Yx(2,1))" 
Write(io_L,107)2,2,Aimag(Yx(2,2)), "# Aimag(Yx(2,2))" 
Write(io_L,107)2,3,Aimag(Yx(2,3)), "# Aimag(Yx(2,3))" 
Write(io_L,107)3,1,Aimag(Yx(3,1)), "# Aimag(Yx(3,1))" 
Write(io_L,107)3,2,Aimag(Yx(3,2)), "# Aimag(Yx(3,2))" 
Write(io_L,107)3,3,Aimag(Yx(3,3)), "# Aimag(Yx(3,3))" 
End If 
...
Write(io_L,106) "Block Yv Q=",Q,"# (Renormalization Scale)" 
...
Write(io_L,106) "Block IMYv Q=",Q,"# (Renormalization Scale)" 
...
Write(io_L,104) 11,Real(gBYGUT,dp), "# gBY" 
Write(io_L,104) 2,Real(g2GUT,dp), "# g2" 
Write(io_L,104) 3,Real(g3GUT,dp), "# g3" 
Write(io_L,104) 4,Real(gBLGUT,dp), "# gBL" 
Write(io_L,104) 10,Real(gYBGUT,dp), "# gYB" 
Write(io_L,106) "Block BLGUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 2,Real(lam2GUT,dp), "# lam2" 
Write(io_L,104) 3,Real(lam3GUT,dp), "# lam3" 
Write(io_L,104) 1,Real(lam1GUT,dp), "# lam1" 
Write(io_L,104) 10,Real(MUPGUT,dp), "# MUP" 
Write(io_L,104) 11,Real(muGUT,dp), "# mu" 
Write(io_L,106) "Block YxGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Real(YxGUT(1,1),dp), "# Real(YxGUT(1,1),dp)" 
Write(io_L,107)1,2,Real(YxGUT(1,2),dp), "# Real(YxGUT(1,2),dp)" 
Write(io_L,107)1,3,Real(YxGUT(1,3),dp), "# Real(YxGUT(1,3),dp)" 
Write(io_L,107)2,1,Real(YxGUT(2,1),dp), "# Real(YxGUT(2,1),dp)" 
Write(io_L,107)2,2,Real(YxGUT(2,2),dp), "# Real(YxGUT(2,2),dp)" 
Write(io_L,107)2,3,Real(YxGUT(2,3),dp), "# Real(YxGUT(2,3),dp)" 
Write(io_L,107)3,1,Real(YxGUT(3,1),dp), "# Real(YxGUT(3,1),dp)" 
Write(io_L,107)3,2,Real(YxGUT(3,2),dp), "# Real(YxGUT(3,2),dp)" 
Write(io_L,107)3,3,Real(YxGUT(3,3),dp), "# Real(YxGUT(3,3),dp)" 
If (MaxVal(Abs(AImag(YxGUT))).gt.0._dp) Then 
Write(io_L,106) "Block IMYxGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Aimag(YxGUT(1,1)), "# Aimag(YxGUT(1,1))" 
Write(io_L,107)1,2,Aimag(YxGUT(1,2)), "# Aimag(YxGUT(1,2))" 
Write(io_L,107)1,3,Aimag(YxGUT(1,3)), "# Aimag(YxGUT(1,3))" 
Write(io_L,107)2,1,Aimag(YxGUT(2,1)), "# Aimag(YxGUT(2,1))" 
Write(io_L,107)2,2,Aimag(YxGUT(2,2)), "# Aimag(YxGUT(2,2))" 
Write(io_L,107)2,3,Aimag(YxGUT(2,3)), "# Aimag(YxGUT(2,3))" 
Write(io_L,107)3,1,Aimag(YxGUT(3,1)), "# Aimag(YxGUT(3,1))" 
Write(io_L,107)3,2,Aimag(YxGUT(3,2)), "# Aimag(YxGUT(3,2))" 
Write(io_L,107)3,3,Aimag(YxGUT(3,3)), "# Aimag(YxGUT(3,3))" 
End If 
...
CurrentPDG2(1) = Abs(PDGhh(i1)) 
Do i2=2,1
CurrentPDG2(2) = Abs(PDGHm) 
Write(io_L,122) CurrentPDG2(1), CurrentPDG2(2), HPPloopHm(i1), " # h(",i1,")-Hm(",i2,")-loop " 
End do 
Do i2=1,1
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(1,16:258)).Gt.BRmin) Then 
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(2,16:258)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(3,16:258)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(1,16:258)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(2,16:258)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(3,16:258)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRFv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRFv(1,28:432)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRFv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRFv(2,28:432)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRFv(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(3))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRFv(3,28:432)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRFv(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(4))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRFv(4,28:432)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRFv(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(5))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRFv(5,28:432)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRFv(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(6))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRFv(6,28:432)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRVWm(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWm)//"^* -> "//Trim(NameParticleVWm)//"^* "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
End if 
...
End if 
icount = icount +1 
If (Maxval(BRhh(1,60:338)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,2
  Do gt2=1,3
...
Write(io_L,202) BRhh(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticlehh(1))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFe(gt3) 
Write(io_L,202) BRhh(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticlehh(1))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleFe(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRhh(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticlehh(1))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRhh(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticlehh(1))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRhh(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticlehh(1))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Write(io_L,202) BRhh(1,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticlehh(1))//" -> "//Trim(NameParticleHm)//"^* "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
Write(io_L,202) BRhh(1,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticlehh(1))//" -> "//Trim(NameParticleHm)//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//" "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRhh(1,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticlehh(1))//" -> "//Trim(NameParticleHm)//"^* "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleFv(gt3))//" "//")"
Write(io_L,202) BRhh(1,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticlehh(1))//" -> "//Trim(NameParticleHm)//" "//Trim(NameParticleFe(gt2))//"^* "//Trim(NameParticleFv(gt3))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = -PDGFe(gt3) 
Write(io_L,202) BRhh(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticlehh(1))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleFe(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRhh(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticlehh(1))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRhh(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticlehh(1))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
End if 
icount = icount +1 
If (Maxval(BRhh(2,60:338)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,2
  Do gt2=1,3
...
CurrentPDG3(2) = PDGFd(gt2) 
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRhh(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticlehh(2))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFe(gt3) 
Write(io_L,202) BRhh(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticlehh(2))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleFe(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRhh(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticlehh(2))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRhh(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticlehh(2))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRhh(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticlehh(2))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(2) = PDGFd(gt2) 
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRhh(2,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticlehh(2))//" -> "//Trim(NameParticleHm)//"^* "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
Write(io_L,202) BRhh(2,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticlehh(2))//" -> "//Trim(NameParticleHm)//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFu(gt3))//" "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRhh(2,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticlehh(2))//" -> "//Trim(NameParticleHm)//"^* "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleFv(gt3))//" "//")"
Write(io_L,202) BRhh(2,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticlehh(2))//" -> "//Trim(NameParticleHm)//" "//Trim(NameParticleFe(gt2))//"^* "//Trim(NameParticleFv(gt3))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = -PDGFe(gt3) 
Write(io_L,202) BRhh(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticlehh(2))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleFe(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRhh(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticlehh(2))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRhh(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticlehh(2))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGVWm 
Write(io_L,201) BRVZp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVZp)//" -> "//Trim(NameParticleVWm)//" "//Trim(NameParticleVWm)//"^* "//")"
End if 
icount = icount +1 
If (Maxval(BRVZp(1,54:296)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(2) = -PDGFd(gt2) 
CurrentPDG3(3) = PDGFd(gt3) 
Write(io_L,202) BRVZp(1,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleVZp)//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFd(gt2))//"^* "//Trim(NameParticleFd(gt3))//" "//")"
Write(io_L,202) BRVZp(1,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleVZp)//" -> "//Trim(NameParticleFd(gt1))//"^* "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = PDGFe(gt3) 
Write(io_L,202) BRVZp(1,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleVZp)//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFe(gt2))//"^* "//Trim(NameParticleFe(gt3))//" "//")"
Write(io_L,202) BRVZp(1,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleVZp)//" -> "//Trim(NameParticleFd(gt1))//"^* "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleFe(gt3))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = PDGFu(gt3) 
Write(io_L,202) BRVZp(1,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleVZp)//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFu(gt2))//"^* "//Trim(NameParticleFu(gt3))//" "//")"
Write(io_L,202) BRVZp(1,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleVZp)//" -> "//Trim(NameParticleFd(gt1))//"^* "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRVZp(1,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleVZp)//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFv(gt3))//" "//")"
Write(io_L,202) BRVZp(1,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleVZp)//" -> "//Trim(NameParticleFd(gt1))//"^* "//Trim(NameParticleFv(gt2))//"^* "//Trim(NameParticleFv(gt3))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG3(3) = PDGFe(gt3) 
Write(io_L,202) BRVZp(1,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleVZp)//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFe(gt3))//" "//")"
Write(io_L,202) BRVZp(1,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleVZp)//" -> "//Trim(NameParticleFu(gt1))//"^* "//Trim(NameParticleFv(gt2))//"^* "//Trim(NameParticleFe(gt3))//"^* "//")"
End if 
icount = icount +1 
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.ZpBminusLSM",status="unknown")
...
Write(123,*) "Yx11_r= ",Real(Yx(1,1),dp)
Write(123,*) "Yx12_r= ",Real(Yx(1,2),dp)
Write(123,*) "Yx13_r= ",Real(Yx(1,3),dp)
Write(123,*) "Yx21_r= ",Real(Yx(2,1),dp)
Write(123,*) "Yx22_r= ",Real(Yx(2,2),dp)
Write(123,*) "Yx23_r= ",Real(Yx(2,3),dp)
Write(123,*) "Yx31_r= ",Real(Yx(3,1),dp)
Write(123,*) "Yx32_r= ",Real(Yx(3,2),dp)
Write(123,*) "Yx33_r= ",Real(Yx(3,3),dp)
Write(123,*) "Yx11_i= ",AImag(Yx(1,1))
Write(123,*) "Yx12_i= ",AImag(Yx(1,2))
Write(123,*) "Yx13_i= ",AImag(Yx(1,3))
Write(123,*) "Yx21_i= ",AImag(Yx(2,1))
Write(123,*) "Yx22_i= ",AImag(Yx(2,2))
Write(123,*) "Yx23_i= ",AImag(Yx(2,3))
Write(123,*) "Yx31_i= ",AImag(Yx(3,1))
Write(123,*) "Yx32_i= ",AImag(Yx(3,2))
Write(123,*) "Yx33_i= ",AImag(Yx(3,3))
...
Subroutine Read_BLIN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Else If (i_par.Eq.10) Then 
If (i_c.Eq.0) MUPIN= Cmplx(wert,Aimag(MUPIN),dp) 
If (i_c.Eq.1) MUPIN= Cmplx(Real(MUPIN,dp),wert,dp) 
InputValueforMUP= .True. 
Else If (i_par.Eq.11) Then 
...
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block BLIN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMBLIN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block BLIN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMBLIN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_BLIN 
...
Subroutine Read_ANGLESIN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
End Module InputOutput_ZpBminusLSM 
