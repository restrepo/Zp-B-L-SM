...
! ------------------------------------------------------------------------------  
! File created at 23:06 on 8.9.2016   
! ----------------------------------------------------------------------  
 
 
Program SPhenoZpBminusLSM 
 
Use Control
Use InputOutput_ZpBminusLSM
Use LoopFunctions
Use RunSM_ZpBminusLSM
Use LowEnergy_ZpBminusLSM
Use FlavorKit_LFV_ZpBminusLSM
Use FlavorKit_QFV_ZpBminusLSM
Use FlavorKit_Observables_ZpBminusLSM
Use Mathematics
Use Model_Data_ZpBminusLSM
Use Tadpoles_ZpBminusLSM 
 Use HiggsCS_ZpBminusLSM
Use TreeLevelMasses_ZpBminusLSM
Use LoopMasses_ZpBminusLSM
 
Use BranchingRatios_ZpBminusLSM
...
& ZH,UV,ZW,ZZ,v,vX,g1,gBY,g2,g3,gBL,gYB,lam2,lam3,lam1,Yx,Yd,Ye,Yv,Yu,MUP,mu,kont)
...
Call CalculateLowEnergyConstraints(g1,gBY,g2,g3,gBL,gYB,lam2,lam3,lam1,               & 
& Yx,Yd,Ye,Yv,Yu,MUP,mu,v,vX,ae,amu,atau,EDMe,EDMmu,EDMtau,dRho,BrBsGamma,               & 
...
If (OutputForMO) Then 
Call RunningFermionMasses(MFe,MFe2,MFd,MFd2,MFu,MFu2,v,vX,g1,gBY,g2,g3,               & 
& gBL,gYB,lam2,lam3,lam1,Yx,Yd,Ye,Yv,Yu,MUP,mu,kont)
...
Subroutine CalculateLowEnergyConstraints(g1input,gBYinput,g2input,g3input,            & 
& gBLinput,gYBinput,lam2input,lam3input,lam1input,Yxinput,Ydinput,Yeinput,               & 
& Yvinput,Yuinput,MUPinput,muinput,vinput,vXinput,ae,amu,atau,EDMe,EDMmu,EDMtau,         & 
...
Real(dp),Intent(inout) :: g1input,gBYinput,g2input,g3input,gBLinput,gYBinput,vinput,vXinput

Complex(dp),Intent(inout) :: lam2input,lam3input,lam1input,Yxinput(3,3),Ydinput(3,3),Yeinput(3,3),Yvinput(3,3),    & 
...
Complex(dp) :: cplAhAhcVWmVWm(2,2),cplAhAhhh(2,2,2),cplAhAhVZVZ(2,2),cplAhcHmVWm(2),cplAhhhVP(2,2),  & 
& cplAhhhVZ(2,2),cplAhhhVZp(2,2),cplAhHmcVWm(2),cplcFdFdAhL(3,3,2),cplcFdFdAhR(3,3,2),   & 
...
& cplcFdFdVZR(3,3),cplcFdFuHmL(3,3),cplcFdFuHmR(3,3),cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),& 
...
& cplcFeFeVZR(3,3),cplcFeFvHmL(3,6),cplcFeFvHmR(3,6),cplcFeFvVWmL(3,6),cplcFeFvVWmR(3,6),& 
& cplcFuFdcHmL(3,3),cplcFuFdcHmR(3,3),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),             & 
...
& cplcFuFuVZpL(3,3),cplcFuFuVZpR(3,3),cplcFuFuVZR(3,3),cplcgAgWmcVWm,cplcgWmgWmVZ,       & 
& cplcgWpCgAcVWm,cplcgWpCgWpCVZ,cplcgWpCgZcVWm,cplcgWpCgZpcVWm,cplcgZgWmcVWm,            & 
& cplcgZpgWmcVWm,cplcHmVPVWm,cplcHmVWmVZ,cplcHmVWmVZp,cplcVWmcVWmVWmVWm1,cplcVWmcVWmVWmVWm2,& 
& cplcVWmcVWmVWmVWm3,cplcVWmVPVPVWm1,cplcVWmVPVPVWm2,cplcVWmVPVPVWm3,cplcVWmVPVWm,       & 
& cplcVWmVWmVZ,cplcVWmVWmVZp,cplcVWmVWmVZpVZp1,cplcVWmVWmVZpVZp2,cplcVWmVWmVZpVZp3,      & 
& cplcVWmVWmVZVZ1,cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,cplFvFecHmL(6,3),cplFvFecHmR(6,3),     & 
& cplFvFecVWmL(6,3),cplFvFecVWmR(6,3),cplFvFvAhL(6,6,2),cplFvFvAhR(6,6,2),               & 
& cplFvFvhhL(6,6,2),cplFvFvhhR(6,6,2),cplFvFvVPL(6,6),cplFvFvVPR(6,6),cplFvFvVZL(6,6),   & 
& cplFvFvVZpL(6,6),cplFvFvVZpR(6,6),cplFvFvVZR(6,6),cplhhcHmVWm(2),cplhhcVWmVWm(2),      & 
& cplhhhhcVWmVWm(2,2),cplhhhhhh(2,2,2),cplhhhhVZVZ(2,2),cplhhHmcHm(2),cplhhHmcVWm(2),    & 
& cplhhVPVZ(2),cplhhVPVZp(2),cplhhVZpVZp(2),cplhhVZVZ(2),cplhhVZVZp(2),cplHmcHmcVWmVWm,  & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcHmVZp,cplHmcHmVZVZ,cplHmcVWmVP,cplHmcVWmVZ,cplHmcVWmVZp,cplVGVGVG
...
gBYinput = Sqrt(5._dp/3._dp)*gBYinput 
gYBinput = Sqrt(2._dp/3._dp)*gYBinput 
...
Qin=sqrt(getRenormalizationScale()) 
scale_save = Qin 
Call RunSM_and_SUSY_RGEs(160._dp,g1input,gBYinput,g2input,g3input,gBLinput,           & 
& gYBinput,lam2input,lam3input,lam1input,Yxinput,Ydinput,Yeinput,Yvinput,Yuinput,        & 
& MUPinput,muinput,vinput,vXinput,g1,gBY,g2,g3,gBL,gYB,lam2,lam3,lam1,Yx,Yd,             & 
& Ye,Yv,Yu,MUP,mu,v,vX,CKM_160,sinW2_160,Alpha_160,AlphaS_160,.false.)
...
MHm=MVWm
MHm2=MVWm2
Call AllCouplings(lam2,lam3,lam1,v,vX,ZH,ZA,g1,g2,gYB,TW,gBL,gBY,TWp,g3,              & 
& Yd,ZDL,ZDR,Ye,ZEL,ZER,Yu,ZUL,ZUR,Yx,Yv,UV,cplAhAhhh,cplhhhhhh,cplhhHmcHm,              & 
...
& MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhhh,          & 
& cplAhcHmVWm,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHmcVWm,cplcFdFdAhL,cplcFdFdAhR,        & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZpL,              & 
& cplcFdFdVZpR,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,            & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,               & 
& cplcFeFeVZL,cplcFeFeVZpL,cplcFeFeVZpR,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,             & 
...
& cplcFuFuVZL,cplcFuFuVZpL,cplcFuFuVZpR,cplcFuFuVZR,cplcHmVPVWm,cplcHmVWmVZ,             & 
& cplcHmVWmVZp,cplcVWmVPVWm,cplcVWmVWmVZ,cplcVWmVWmVZp,cplFvFecHmL,cplFvFecHmR,          & 
& cplFvFecVWmL,cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,      & 
& cplFvFvVPR,cplFvFvVZL,cplFvFvVZpL,cplFvFvVZpR,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,     & 
& cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,           & 
& cplhhVZVZp,cplHmcHmVP,cplHmcHmVZ,cplHmcHmVZp,cplHmcVWmVP,cplHmcVWmVZ,cplHmcVWmVZp,     & 
...
& MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,               & 
& cplAhAhhh,cplAhcHmVWm,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHmcVWm,cplcFdFdAhL,          & 
& cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,               & 
& cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,            & 
& cplcFdFuVWmR,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,              & 
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZpL,cplcFeFeVZpR,cplcFeFeVZR,cplcFeFvHmL,             & 
...
& cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZpL,cplcFuFuVZpR,cplcFuFuVZR,cplcHmVPVWm,             & 
& cplcHmVWmVZ,cplcHmVWmVZp,cplcVWmVPVWm,cplcVWmVWmVZ,cplcVWmVWmVZp,cplFvFecHmL,          & 
& cplFvFecHmR,cplFvFecVWmL,cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,     & 
& cplFvFvVPL,cplFvFvVPR,cplFvFvVZL,cplFvFvVZpL,cplFvFvVZpR,cplFvFvVZR,cplhhcHmVWm,       & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,        & 
& cplhhVZVZ,cplhhVZVZp,cplHmcHmVP,cplHmcHmVZ,cplHmcHmVZp,cplHmcVWmVP,cplHmcVWmVZ,        & 
& cplHmcVWmVZp,PSOddvvVRR(gt1,gt2,gt3,gt4),PSOddvvVLL(gt1,gt2,gt3,gt4),PSOddvvVRL(gt1,gt2,gt3,gt4)& 
...
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,        & 
& cplhhVZVZ,cplhhVZVZp,cplHmcHmVP,cplHmcHmVZ,cplHmcHmVZp,cplHmcVWmVP,cplHmcVWmVZ,        & 
& cplHmcVWmVZp,PVOddvvVRR(gt1,gt2,gt3,gt4),PVOddvvVLL(gt1,gt2,gt3,gt4),PVOddvvVRL(gt1,gt2,gt3,gt4)& 
...
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,        & 
& cplhhVZVZ,cplhhVZVZp,cplHmcHmVP,cplHmcHmVZ,cplHmcHmVZp,cplHmcVWmVP,cplHmcVWmVZ,        & 
& cplHmcVWmVZp,TSOddvvVRR(gt1,gt2,gt3,gt4),TSOddvvVLL(gt1,gt2,gt3,gt4),TSOddvvVRL(gt1,gt2,gt3,gt4)& 
...
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,        & 
& cplhhVZVZ,cplhhVZVZp,cplHmcHmVP,cplHmcHmVZ,cplHmcHmVZp,cplHmcVWmVP,cplHmcVWmVZ,        & 
& cplHmcVWmVZp,TVOddvvVRR(gt1,gt2,gt3,gt4),TVOddvvVLL(gt1,gt2,gt3,gt4),TVOddvvVRL(gt1,gt2,gt3,gt4)& 
...
& Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhhh,cplAhcHmVWm,cplAhhhVP,      & 
& cplAhhhVZ,cplAhhhVZp,cplAhHmcVWm,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,      & 
...
& cplcFuFuVZL,cplcFuFuVZpL,cplcFuFuVZpR,cplcFuFuVZR,cplcHmVPVWm,cplcHmVWmVZ,             & 
& cplcHmVWmVZp,cplcVWmVPVWm,cplcVWmVWmVZ,cplcVWmVWmVZp,cplhhcHmVWm,cplhhcVWmVWm,         & 
& cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,           & 
& cplhhVZVZp,cplHmcHmVP,cplHmcHmVZ,cplHmcHmVZp,cplHmcVWmVP,cplHmcVWmVZ,cplHmcVWmVZp,     & 
...
& MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhhh,cplAhcHmVWm,cplAhhhVZ,               & 
& cplAhhhVZp,cplAhHmcVWm,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,    & 
...
& MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhcHmVWm,        & 
& cplAhHmcVWm,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,               & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFdFuHmL,             & 
...
& cplcFuFuVZR,cplcHmVPVWm,cplcHmVWmVZ,cplcHmVWmVZp,cplcVWmVWmVZ,cplcVWmVWmVZp,           & 
...
& cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhHmcHm,cplhhHmcVWm,cplHmcHmVP,cplHmcHmVZ,      & 
& cplHmcHmVZp,cplHmcVWmVP,cplHmcVWmVZ,cplHmcVWmVZp,TSOdulvSLL(gt1,gt2,gt3,gt4)           & 
...
& cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,cplFvFvVZL,cplFvFvVZpL,cplFvFvVZpR,        & 
& cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhHmcHm,cplhhHmcVWm,cplHmcHmVP,cplHmcHmVZ,      & 
& cplHmcHmVZp,cplHmcVWmVP,cplHmcVWmVZ,cplHmcVWmVZp,TVOdulvSLL(gt1,gt2,gt3,gt4)           & 
...
& Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhhhVP,cplcFdFdAhL,cplcFdFdAhR,        & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,               & 
& cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,             & 
& cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,       & 
& cplcFuFuVPL,cplcFuFuVPR,cplcHmVPVWm,cplcVWmVPVWm,cplhhVPVZ,cplhhVPVZp,cplHmcHmVP,      & 
& cplHmcVWmVP,OA2qSL(gt1,gt2),OA2qSR(gt1,gt2),OA2qVL(gt1,gt2),OA2qVR(gt1,gt2))
...
& Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,      & 
& cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,               & 
& cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,            & 
& cplcFdFuVWmR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuVGL,        & 
...
& MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhhh,cplAhhhVZ,cplAhhhVZp,cplcFdFdAhL,    & 
...
& cplhhHmcHm,cplhhHmcVWm,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,OH2qSL(gt1,gt2,gt3)            & 
& ,OH2qSR(gt1,gt2,gt3))
...
& Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhhh,cplAhcHmVWm,cplAhhhVP,          & 
& cplAhhhVZ,cplAhhhVZp,cplAhHmcVWm,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,      & 
& cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZpL,              & 
& cplcFdFdVZpR,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,            & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuAhL,cplcFuFuAhR,         & 
...
& cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,cplFvFvVZL,cplFvFvVZpL,cplFvFvVZpR,        & 
& cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhHmcHm,cplhhHmcVWm,cplHmcHmVP,cplHmcHmVZ,      & 
& cplHmcHmVZp,cplHmcVWmVP,cplHmcVWmVZ,cplHmcVWmVZp,TSOdulvSLLSM(gt1,gt2,gt3,gt4)         & 
...
& cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,cplFvFvVZL,cplFvFvVZpL,cplFvFvVZpR,        & 
& cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhHmcHm,cplhhHmcVWm,cplHmcHmVP,cplHmcHmVZ,      & 
& cplHmcHmVZp,cplHmcVWmVP,cplHmcVWmVZ,cplHmcVWmVZp,TVOdulvSLLSM(gt1,gt2,gt3,gt4)         & 
...
& cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,       & 
& cplcFuFuVPL,cplcFuFuVPR,cplcHmVPVWm,cplcVWmVPVWm,cplhhVPVZ,cplhhVPVZp,cplHmcHmVP,      & 
& cplHmcVWmVP,OA2qSLSM(gt1,gt2),OA2qSRSM(gt1,gt2),OA2qVLSM(gt1,gt2),OA2qVRSM(gt1,gt2))
...
& cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,         & 
& cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,              & 
& cplhhHmcHm,cplhhHmcVWm,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,OH2qSLSM(gt1,gt2,gt3)          & 
...
Call RunSM_and_SUSY_RGEs(mz,g1input,gBYinput,g2input,g3input,gBLinput,gYBinput,       & 
& lam2input,lam3input,lam1input,Yxinput,Ydinput,Yeinput,Yvinput,Yuinput,MUPinput,        & 
& muinput,vinput,vXinput,g1,gBY,g2,g3,gBL,gYB,lam2,lam3,lam1,Yx,Yd,Ye,Yv,Yu,             & 
& MUP,mu,v,vX,CKM_MZ,sinW2_MZ,Alpha_MZ,AlphaS_MZ,.true.)
...
& Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhhh,cplAhcHmVWm,cplAhhhVP,      & 
& cplAhhhVZ,cplAhhhVZp,cplAhHmcVWm,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,      & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZpL,cplcFeFeVZpR,cplcFeFeVZR,             & 
& cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcHmVPVWm,cplcHmVWmVZ,             & 
& cplcHmVWmVZp,cplcVWmVPVWm,cplcVWmVWmVZ,cplcVWmVWmVZp,cplFvFecHmL,cplFvFecHmR,          & 
& cplFvFecVWmL,cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,      & 
& cplFvFvVPR,cplFvFvVZL,cplFvFvVZpL,cplFvFvVZpR,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,     & 
& cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,           & 
...
& MFv2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhhh,cplAhcHmVWm,           & 
& cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHmcVWm,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,        & 
& cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZpL,cplcFeFeVZpR,             & 
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcHmVPVWm,             & 
& cplcHmVWmVZ,cplcHmVWmVZp,cplcVWmVPVWm,cplcVWmVWmVZ,cplcVWmVWmVZp,cplFvFecHmL,          & 
& cplFvFecHmR,cplFvFecVWmL,cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,     & 
& cplFvFvVPL,cplFvFvVPR,cplFvFvVZL,cplFvFvVZpL,cplFvFvVZpR,cplFvFvVZR,cplhhcHmVWm,       & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,        & 
& cplhhVZVZ,cplhhVZVZp,cplHmcHmVP,cplHmcHmVZ,cplHmcHmVZp,cplHmcVWmVP,cplHmcVWmVZ,        & 
& cplHmcVWmVZp,BO4lSLLcross(gt1,gt2,gt3,gt4),BO4lSRRcross(gt1,gt2,gt3,gt4)               & 
...
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,        & 
& cplhhVZVZ,cplhhVZVZp,cplHmcHmVP,cplHmcHmVZ,cplHmcHmVZp,cplHmcVWmVP,cplHmcVWmVZ,        & 
& cplHmcVWmVZp,PSO4lSLLcross(gt1,gt2,gt3,gt4),PSO4lSRRcross(gt1,gt2,gt3,gt4)             & 
...
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,        & 
& cplhhVZVZ,cplhhVZVZp,cplHmcHmVP,cplHmcHmVZ,cplHmcHmVZp,cplHmcVWmVP,cplHmcVWmVZ,        & 
& cplHmcVWmVZp,PVO4lSLLcross(gt1,gt2,gt3,gt4),PVO4lSRRcross(gt1,gt2,gt3,gt4)             & 
...
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,        & 
& cplhhVZVZ,cplhhVZVZp,cplHmcHmVP,cplHmcHmVZ,cplHmcHmVZp,cplHmcVWmVP,cplHmcVWmVZ,        & 
& cplHmcVWmVZp,TSO4lSLLcross(gt1,gt2,gt3,gt4),TSO4lSRRcross(gt1,gt2,gt3,gt4)             & 
...
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,        & 
& cplhhVZVZ,cplhhVZVZp,cplHmcHmVP,cplHmcHmVZ,cplHmcHmVZp,cplHmcVWmVP,cplHmcVWmVZ,        & 
& cplHmcVWmVZp,TVO4lSLLcross(gt1,gt2,gt3,gt4),TVO4lSRRcross(gt1,gt2,gt3,gt4)             & 
...
& Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhhhVP,cplcFeFeAhL,cplcFeFeAhR,        & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZpL,              & 
& cplcFeFeVZpR,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,            & 
& cplcHmVPVWm,cplcVWmVPVWm,cplFvFecHmL,cplFvFecHmR,cplFvFecVWmL,cplFvFecVWmR,            & 
& cplFvFvVPL,cplFvFvVPR,cplhhVPVZ,cplhhVPVZp,cplHmcHmVP,cplHmcVWmVP,OA2lSL(gt1,gt2)      & 
...
& MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhhh,cplAhhhVZ,cplAhhhVZp,cplcFeFeAhL,    & 
& cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,               & 
& cplcFeFeVZpL,cplcFeFeVZpR,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,            & 
& cplcFeFvVWmR,cplFvFecHmL,cplFvFecHmR,cplFvFecVWmL,cplFvFecVWmR,cplFvFvhhL,             & 
& cplFvFvhhR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVZpVZp,      & 
...
& MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,             & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZpL,              & 
& cplcFeFeVZpR,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,            & 
& cplcHmVWmVZ,cplcVWmVWmVZ,cplFvFecHmL,cplFvFecHmR,cplFvFecVWmL,cplFvFecVWmR,            & 
& cplFvFvVZL,cplFvFvVZR,cplhhVZVZ,cplhhVZVZp,cplHmcHmVZ,cplHmcVWmVZ,OZ2lSL(gt1,gt2)      & 
...
& cplcFeFeAhR,cplAhhhVP,cplFvFecHmL,cplFvFecHmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,     & 
& cplcFeFeVPR,cplFvFvVPL,cplFvFvVPR,cplcFeFvHmL,cplcFeFvHmR,cplHmcHmVP,ae)

Call Gminus2(2,MAh,MAh2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHm,MHm2,cplcFeFeAhL,              & 
& cplcFeFeAhR,cplAhhhVP,cplFvFecHmL,cplFvFecHmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,     & 
& cplcFeFeVPR,cplFvFvVPL,cplFvFvVPR,cplcFeFvHmL,cplcFeFvHmR,cplHmcHmVP,amu)

Call Gminus2(3,MAh,MAh2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHm,MHm2,cplcFeFeAhL,              & 
& cplcFeFeAhR,cplAhhhVP,cplFvFecHmL,cplFvFecHmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,     & 
& cplcFeFeVPR,cplFvFvVPL,cplFvFvVPR,cplcFeFvHmL,cplcFeFvHmR,cplHmcHmVP,atau)


! *****  Lepton EDM ***** 

Call LeptonEDM(1,MAh,MAh2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,             & 
& MVZ,MVZ2,MVZp,MVZp2,cplcFeFeAhL,cplcFeFeAhR,cplAhhhVP,cplFvFecHmL,cplFvFecHmR,         & 
& cplFvFecVWmL,cplFvFecVWmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,             & 
...
mW2=(1._dp-sinW2)*mz2 + (g2**2*(-(Sqrt(g1**2 + g2**2)*(g1**4*v**2 + g2**4*v**2 + 2*g1**2*(g2**2*v**2 + 8*gYB**2*vX**2))*Cos(TWp)**2) + 16*g1*gBL*gYB*(g1**2 + g2**2)*vX**2*Sin(2._dp*(TWp)) + (g1**2 + g2**2)*(-(Sqrt(g1**2 + g2**2)*(gBY**2*v**2 + 16*gBL**2*vX**2)*Sin(TWp)**2) + (g1**2 + g2**2)*v**2*(Sqrt(g1**2 + g2**2) + gBY*Sin(2._dp*(TWp))))))/(4._dp*(g1**2 + g2**2)**2.5_dp)
vev2=Sqrt(mZ2*(1._dp-sinW2)*SinW2/(pi*alpha)) +((-(g1**2*v**2) + (g1**2*v**2 + 16*gYB**2*vX**2)*Cos(TWp)**2)*Sin(TW)**2 + (gBY**2*v**2 + 16*gBL**2*vX**2)*Sin(TWp)**2 - g2**2*v**2*Cos(TW)**2*Sin(TWp)**2 - 2*g2*v**2*Cos(TW)*Sin(TWp)*(gBY*Cos(TWp) + g1*Sin(TW)*Sin(TWp)) - (g1*gBY*v**2 + 16*gBL*gYB*vX**2)*Sin(TW)*Sin(2._dp*(TWp)))/4._dp 
v=vev2 
Call SolveTadpoleEquations(g1,gBY,g2,g3,gBL,gYB,lam2,lam3,lam1,Yx,Yd,Ye,              & 
& Yv,Yu,MUP,mu,v,vX,(/ ZeroC, ZeroC /))
...
& MHm2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhcVWmVWm,cplAhAhVZVZ,cplAhhhVZ,              & 
...
& cplHmcHmVZ,cplHmcHmVZVZ,cplHmcVWmVP,cplHmcVWmVZ,cplHmcVWmVZp,dRho)
