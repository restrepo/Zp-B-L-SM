...
Module LoopCouplings_ZpBminusLSM 
...
Implicit None 
Complex(dp),Intent(in) :: ratFd(3),ratFe(3),ratFu(3),ratHm,ratVWm

Real(dp),Intent(in) :: MFd(3),MFe(3),MFu(3),MHm,MVWm
...
coup = coup + 1*(-1)**2*ratHm*A_zero(mH2p/MHm**2)
HPPloopHm(inG) = HPPloopHm(inG)+1*(-1)**2*ratHm*A_zero(mH2p/MHm**2)
...
End Module LoopCouplings_ZpBminusLSM 
