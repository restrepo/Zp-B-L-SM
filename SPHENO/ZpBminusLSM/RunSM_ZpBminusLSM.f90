...
Contains 
 ...
 Subroutine RunSM_and_SUSY_RGEs(Qout,g1input,gBYinput,g2input,g3input,gBLinput,        & 
...
& Ye,Yv,Yu,MUP,mu,v,vX,CKMout,sinW2_out,Alpha_out,AlphaS_out,realCKM)
...
Real(dp) :: scale_save, Qin, tz, dt, g1D(108), g62_SM(62) 
 
 
! Run SUSY RGEs from M_SUSY to Qin 
Qin=sqrt(getRenormalizationScale()) 
scale_save = Qin 
Call ParametersToG108(g1input,gBYinput,g2input,g3input,gBLinput,gYBinput,             & 
& lam2input,lam3input,lam1input,Yxinput,Ydinput,Yeinput,Yvinput,Yuinput,MUPinput,        & 
& muinput,vinput,vXinput,g1D)

Call GToParameters108(g1D,g1,gBY,g2,g3,gBL,gYB,lam2,lam3,lam1,Yx,Yd,Ye,               & 
& Yv,Yu,MUP,mu,v,vX)

g1 = Sqrt(3._dp/5._dp)*g1 
gBL = Sqrt(3._dp/2._dp)*gBL 
gBY = Sqrt(3._dp/5._dp)*gBY 
gYB = Sqrt(3._dp/2._dp)*gYB 
