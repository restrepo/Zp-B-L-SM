...
Real(dp) :: g1,gBY,g2,g3,gBL,gYB

Complex(dp) :: lam2,lam3,lam1,Yx(3,3),Yd(3,3),Ye(3,3),Yv(3,3),Yu(3,3),MUP,mu

Real(dp) :: g1IN,gBYIN,g2IN,g3IN,gBLIN,gYBIN

Complex(dp) :: lam2IN,lam3IN,lam1IN,YxIN(3,3),YdIN(3,3),YeIN(3,3),YvIN(3,3),YuIN(3,3),               & 
& MUPIN,muIN

Real(dp) :: g1MZ,gBYMZ,g2MZ,g3MZ,gBLMZ,gYBMZ

Complex(dp) :: lam2MZ,lam3MZ,lam1MZ,YxMZ(3,3),YdMZ(3,3),YeMZ(3,3),YvMZ(3,3),YuMZ(3,3),               & 
& MUPMZ,muMZ

Real(dp) :: g1GUT,gBYGUT,g2GUT,g3GUT,gBLGUT,gYBGUT

Complex(dp) :: lam2GUT,lam3GUT,lam1GUT,YxGUT(3,3),YdGUT(3,3),YeGUT(3,3),YvGUT(3,3),YuGUT(3,3),       & 
& MUPGUT,muGUT
...
Real(dp) :: ratioPFd(2,3),ratioPFe(2,3),ratioPFu(2,3),ratioPHm(2),ratioPVWm(2)

Complex(dp) :: ratioPGG(2),ratioPPP(2)

Real(dp) :: gForTadpoles(108)
...
Logical, save :: InputValueforMUP =.False. 
Logical, save :: InputValueformu =.False. 
Logical, save :: InputValueforvX =.False. 
...
Complex(dp) :: g1pINPUT
Complex(dp) :: g1p1INPUT
Complex(dp) :: g11pINPUT
Complex(dp) :: vXinput
Real(dp) :: vMZ 
Real(dp) :: vSUSY 
Real(dp) :: vXMZ 
...
Real(dp) :: rHB_P_P_Fv(2,6),rHB_P_S_Fv(2,6),rHB_S_S_Fv(2,6),rHB_S_P_Fv(2,6)
...
g1pINPUT=(0._dp,0._dp) 
g1p1INPUT=(0._dp,0._dp) 
g11pINPUT=(0._dp,0._dp) 
vXinput=(0._dp,0._dp) 
End Subroutine Set_All_Parameters_0 
 


End Module Model_Data_ZpBminusLSM